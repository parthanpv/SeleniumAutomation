...
public class Product_with_variation {
 ...
 //   @FindBy(xpath="//label[contains(text(),'Amount')]/ancestor::div[1]/div[1]/input") 
   ...
   // @FindBy(xpath="//*[text()='Stock']/ancestor::div[1]/div[1]/input") 
    ...
    @CacheLookup
    @FindBy(xpath="//form[@name='searchForm']/div[1]/div[1]/h3[1]")  
    WebElement Confirm_product_page_title; 
...
//------------------------------------------------------------------------------------------------------------------------------ 
	...
	public Product_with_variation(WebDriver driver) {
		this.driver = driver;
	...
	try {
		...
		color.click();
			...
			try {
				...
				if(variatn_iem_count==3) {Reporter.log("product only show the same variation type and hide others -Test pass",true);
...
//-----------------------------Get_product page title--------------------------------------------------

public void Get_product_page_title(){
	
	try {
		Wait_Utility.Wait_for_Elmnt_Visible(driver, Confirm_product_page_title, 30);
		
		String p_ti= Confirm_product_page_title.getText();
		
		if(p_ti=="Product List")
		{
			Reporter.log("Verify submit button navigate to List page ",true);
			Reporter.log("Test pass ",true);
		}
		...
		WebElement Confirm_product_page_title2 = driver.findElement(By.xpath("//form[@name='searchForm']/div[1]/div[1]/h3[1]"));
		Wait_Utility.Wait_for_Elmnt_Visible(driver, Confirm_product_page_title2,20);
		String p_ti= Confirm_product_page_title.getText();
		if(p_ti=="Product List")
		{
			Reporter.log("Verify submit button navigate to List page ",true);
